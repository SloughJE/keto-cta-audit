...
(i) **Model strategy** ([M1](#appx-m1)): The paper relies on **unadjusted univariable change-score** models; field-standard is ANCOVA (follow-up ∼ baseline + exposure + age/sex/BP).[@vanrosendael2021; @han2020] ANCOVA avoids baseline–change artifacts and yields clearer estimates.[@vickers2001; @tu2007] Omitting age/sex/BP (available in the dataset) leaves associations likely confounded.[@lehman2009; @han2020] "Predicts/predictor" is used for association models without validated prognostic performance.[@moons2015]
