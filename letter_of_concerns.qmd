...
(i) **Model strategy** ([M1](#appx-m1)): Standard plaque-progression analyses use baseline-adjusted follow-up (ANCOVA).[@vanrosendael2021; @han2020] ANCOVA is preferred to change-scores in observational data because it avoids baseline–change artifacts and gives more interpretable effects.[@vickers2001; @tu2007; @clifton2019; @chiolero2013] The unadjusted univariable change-score models do not include known and available confounders[@lehman2009; @han2020], leading to bias.
...
**Example of the cited diagnostic suite.** The output of `performance::check_model` for $\Delta$NCPV $\sim$ CAC$_{bl}$ shows nonlinearity (non-flat residual smooth), heteroskedasticity (funneling in the scale–location plot), and non-normal residuals (Q–Q tails), consistent with the tests above.
