# -----------------------------------------------------------------------------
# Script : 01_reproduce_figures.R
# Purpose: Recreate Figures 1A, 1B and 2F from the published paper, and
#          save corrected PNGs in figures/reproduced/.
# Links  : Supports Critical issues C1–C3 in the letter of concern:
#            • C1 – Figure 1B y-axis mislabelled
#            • C2 – Figures 1A–1B shaded IQR incorrect
#            • C3 – Figures 2D–2F y-axis mislabelled
# -----------------------------------------------------------------------------
...
save_png(figure_1A, "figures/reproduced/Figure1A.png", width = 6, height = 5.86, dpi = 800)
save_png(figure_1B, "figures/reproduced/Figure1B.png", width = 6, height = 6.23, dpi = 800)
save_png(figure_2F, "figures/reproduced/Figure2F.png", width = 6, height = 6.26, dpi = 800)
