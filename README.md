...
| **02_linear_model_checks.R** | Formal assumption tests (Breusch–Pagan, Shapiro, RESET) turned into Table C5; `performance::check_model()` grid for ΔNCPV ∼ CAC<sub>bl</sub>; ΔTPS ∼ CAC<sub>bl</sub> model check; Supplementary analysis for M1 | C4, C5, M1 |
